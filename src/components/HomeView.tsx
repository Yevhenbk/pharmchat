...
const HomeView: FC<HomeViewProps> = ({children}) => {
  return (
    ...
    bg-black sm:rounded-t-[30px] md:rounded-none md:px-6 md:border-l-[1px] border-secondaryGrey">
      <div className="relative flex w-full grow flex-col items-center justify-center gap-4">
        ...
        <p className="text-center text-sm leading-[1.2] md:text-md md:leading-4 text-teritaryGrey font-medium
        mb-4 w-[80%]">
      ...
      <div className="mt-10 flex flex-col justify-center text-teritaryGrey">
