...
const ChatView: FC<ChatViewProps> = ({children, user}) => {
  ...
  font-medium h-8 text-xs border-[1px] border-secondaryGrey hover:bg-secondaryGrey w-20`

  return (
    <div className="relative flex grow flex-col items-center justify-between  text-white 
    bg-black sm:rounded-t-[30px] md:rounded-none md:px-6 md:border-l-[1px] border-secondaryGrey w-[100dvvh]
    overflow-hidden">
