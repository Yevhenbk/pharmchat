...
import styles from "./slide-4.module.scss";
  ...
  return (
    <div className={`${sharedStyles.slide} ${sharedStyles.slideDark}`}>
      <div className={styles.authWrap}>
        {/* Brand — matches sidebar .brand exactly */}
        ...
        <div className={styles.authContent}>
          <div className={styles.label}>
            Sign in and start procuring smarter
          </div>
          ...
          <button type="button" className={styles.demoBtn} onClick={onEnterDemo}>
            Enter Demo
          </button>
        </div>
      </div>
